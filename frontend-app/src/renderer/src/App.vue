...
<template>
  ...
  <div class="links">
    <div class="link-item">
      <a target="_blank" href="https://github.com/danmxli/movie-search-engine">Project Github</a>
    </div>
    <div class="link-item link-dot">•</div>
    <div class="link-item">
      <a target="_blank" href="https://github.com/danmxli">Central Repository Hub</a>
    </div>
  </div>
